...
#
# Usage:
# Ubuntu / Debian: wget https://raw.githubusercontent.com/relybv/dirict-role_appl/master/files/bootstrap.sh; bash bootstrap.sh
#
# Red Hat / CentOS: curl https://raw.githubusercontent.com/relybv/dirict-role_appl/master/files/bootstrap.sh -o bootstrap.sh; bash bootstrap.sh
...
function provision_ubuntu {
    ...
    apt-get -y -q --force-yes -o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confold" install git $AGENTNAME >/dev/null
