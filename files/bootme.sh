#!/usr/bin/env bash
#
# This script installs puppet 3.x or 4.x and deploy the manifest using puppet apply -e "include role_appl"
#
# Usage:
# Ubuntu / Debian: wget https://raw.githubusercontent.com/relybv/dirict-role_appl/master/files/bootme.sh; bash bootme.sh
#
# Red Hat / CentOS: curl https://raw.githubusercontent.com/relybv/dirict-role_appl/master/files/bootme.sh -o bootme.sh; bash bootme.sh
...
/usr/local/bin/puppet apply -e "include role_appl" --write-catalog-summary --log_level=error
